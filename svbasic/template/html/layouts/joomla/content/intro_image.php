...
<?php if (isset($images->image_intro) && !empty($images->image_intro)) : ?>
	...
	<div class="item-image-<?php echo htmlspecialchars($imgfloat, ENT_COMPAT, 'UTF-8'); ?> item-image"> 
	...
	?>
		...
		<?php endif; ?>
		src="<?php echo htmlspecialchars($images->image_intro, ENT_COMPAT, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($images->image_intro_alt, ENT_COMPAT, 'UTF-8'); ?>" style= "width:100%;" itemprop="thumbnailUrl"/></a>
	<?php else :
	echo 'No entro:';
	 ?>
	<img
