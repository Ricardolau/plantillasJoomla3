...
<div class="blog <?php echo $this->pageclass_sfx; ?>" >
	...
	<!--- Insertamos categoria del articulo  --> 
	...
	<?php } else {
		/* Lo que pretendemos es que muestre el titulo del item cuando no tengamos activo el mostrar
		 * el nombre o link de la categoria,ya que sino se repite 
		 * y queda mal*/
	...
	<?php if ($info == 0 && $params->get('show_tags', 1) && !empty($this->item->tags->itemTags)) : ?>
		...
		<?php endif; ?>
	<!-- Fin de los Tags -->
	<!-- Ahora iniciamos mostrar Articulo   -->
	<div class="Articulo">
	

	<?php  // Ahora imprimos titulo de Articulo
		...
		<?php /* Eliminamos la presentación detalles 
