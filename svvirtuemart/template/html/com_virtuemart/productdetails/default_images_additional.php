...
<div class="col-md-12 additional-images">
	...
	for ($i = $start_image; $i < count($this->product->images); $i++) {
		...
		?>
		<div class="col-md-3 Mini-Imagen-Producto">
			<?php
			if(VmConfig::get('add_img_main', 1)) {
				echo $image->displayMediaThumb('class="product-image" style="cursor: pointer"',false,"");
				echo '<a href="'. $image->file_url .'"  class="product-image image-'. $i .'" style="display:none;" title="'. $image->file_title .'" rel="vm-additional-images"></a>';
			} else {
