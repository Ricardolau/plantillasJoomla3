...
<?php   }
    ...
    <form id="com-form-login" action="<?php echo $url; ?>" method="post" name="com-login" >
      <fieldset class="userdata">
        ...
        <h4 class="Rojo"><?php echo vmText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></h4>
        </div>
        <?php } else { ?>
        <div class="col-md-3" style="padding:0px;">
        <h4 class="Rojo"><?php echo vmText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></h4>
        ...
        <?php }   ?>
        <div class="col-md-3" id="com-form-login-username">
        ...
        <div class="col-md-3" id="com-form-login-password">
        ...
        <div class="col-md-3" id="com-form-login-remember">
