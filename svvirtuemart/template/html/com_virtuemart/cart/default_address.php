...
?>
<div>
	<div class="facturacion billto-shipto">
			<h2 class="LetraVerde">
	...
	<?php // No muestro direcciones de envio si no esta registrado.
	if($this->cart->user->virtuemart_user_id !=0){
	?>
	<div class="DomicilioEnvio">
		<h2 class="LetraVerde" style="margin-top: 20px;font-family: Daydreamer;  font-size: 32px;">
		...
		<div class="output-shipto">
			...
			if($this->cart->user->virtuemart_user_id==0){
				// Si ni esta logueado mostraba check para indicar la misma dirección de envio que el facturación
				// lo vimos absurdo en esta plantilla y lo comentamos.
	...
	<?php // No mostramos si no esta registrado
	}
