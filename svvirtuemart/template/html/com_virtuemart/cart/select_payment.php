...
if($this->cart->virtuemart_paymentmethod_id){
	echo '<p class="vm-payment-header-selected">'.vmText::_('COM_VIRTUEMART_CART_SELECTED_PAYMENT_SELECT').'</p>';
} else {
	echo '<p class="vm-payment-header-select">'.vmText::_('COM_VIRTUEMART_CART_SELECT_PAYMENT').'</p>';
} ?>
