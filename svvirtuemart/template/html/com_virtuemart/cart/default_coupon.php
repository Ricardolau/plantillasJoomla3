...
<?php } ?>
    ...
    <input class="vm-button-correct" style="font-size:0.8em;" type="submit" name="setcoupon" title="<?php echo vmText::_('COM_VIRTUEMART_SAVE'); ?>" value="<?php echo 'Validar codigo';//vmText::_('COM_VIRTUEMART_SAVE'); ?>"/>
    </span>
<?php
if ($this->layoutName!='default') {
?>
