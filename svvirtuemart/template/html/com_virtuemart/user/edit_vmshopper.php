...
?>
<!-- Estoy en template virtuemart/user/edit_vmshopper -->
<fieldset class="VmShopperTemplate">
...
<?php } ?>
		...
		<tr>
			...
			<?php } else {
				?>
				<input type="password" value="<?php	echo $this->lists['custnumber'];?>" disabled/>
			<?php
			} ?>
			</td>
		</tr>
